...
exports.register_actuator_type = function(description) {
  return new Promise((resolve, reject) => {
...
exports.register_actuator = function(driver_id, actuator_type_id, controller_id, vendor_id, vendor_actuator_id, description, location) {
  return new Promise((resolve, reject) => {
